...
const florencia = {
  ...
  background: "Contadora Pública reconvertida en Dev 🚀",
  bootcamp:   "Henry Bootcamp – Fullstack + Backend Specialization",
  location:   "Resistencia, Chaco, Argentina 📍",
  looking:    "Open to work ✅",
  superpower: "Entiendo el negocio detrás del código 💡"
};
```
...
- 📋 Registro de usuarios, solicitud y agendamiento de capacitaciones
- 💳 Integración con **Mercado Pago** para pagos online
- 🤖 Chatbot con IA para asistencia al usuario
- 🔔 Notificaciones automáticas con **CRON jobs**
...
- 🔐 Autenticación, manejo de órdenes y control de stock
- 🏗️ Arquitectura modular con **NestJS** y **TypeORM**
